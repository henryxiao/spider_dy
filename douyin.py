...
def init_users():
    user_init = {
        '98358605641': ['装修报', 116993040],
        '100862336322': ['设计师小北', 116993036],
        '61720863694': ['装修有诀窍', 116993037],
        '100505274330': ['装修设计案例', 116993038],
        '15209887185': ['小户型装修设计', 116993044],
        '91655709765': ['齐家小菜', 116993045],
        '82828586057': ['室内设计师涂小姐', 116993046],
        '82910948620': ['绘点装修', 116993047],
        # '85228201464': ['流行装修风格', 116993048], not found
        '98347294386': ['美式Fan', 116993049],
        '98311307904': ['装修妙招', 116993051],
        '68508030135': ['小宝聊装修', 116993053],
        '91578824985': ['一起看装修', 116993041],
        '94481282396': ['家装设计师静静', 116993042],
        '100583326009': ['装修课堂', 100354182],
        '95839228087': ['装修讲堂', 101453452],
        '98137834881': ['大叔聊装修', 6043854]
    }
